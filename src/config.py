...
DEFAULT_CONFIG = {
    ...
    "export": {
        ...
        "dxf_show_component_labels": None,
        "dxf_show_pin_markers": None,
        "dxf_show_node_markers": None,
        "dxf_show_net_labels": None,
        "dxf_show_junction_dots": None,
        "dxf_show_title_block": None,
    ...
    "repair": {
        ...
        "component_axis_review_confidence_threshold": 0.75,
    },
    "agent": {
